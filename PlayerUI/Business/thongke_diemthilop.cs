...
{
    class thongke_diemthilop
    {
        Data a = new Data();
        public DataTable hienthi(string s1,string s2)
        {
            string sql = "SELECT SBD AS N'Số Báo Danh',HOTEN as N'Họ tên',NGAYSINH as N'Ngày sinh',DIEM as N'Điểm'  FROM DBO.THONGKEDIEMTHITHEOLOP('"+s1+"',N'"+s2+"') ";
            return a.GET(sql);
        }
